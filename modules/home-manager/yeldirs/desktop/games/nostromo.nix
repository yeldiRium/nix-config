...
let
  ...
  cfg = config.yeldirs.desktop.games.nostromo;
in
{
  options = {
    yeldirs.desktop.games.nostromo = {
  ...
  config = lib.mkIf (desktopCfg.enable && cfg.enable) {
    ...
    xdg.configFile = {
      "autostart/input-mapper-autoload.desktop".source =
        "${osConfig.services.input-remapper.package}/share/applications/input-remapper-autoload.desktop";
