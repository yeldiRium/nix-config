{
  ...
  cfg = config.yeldirs.cli.neovim.testing;
...
in {
  options = {
    yeldirs.cli.neovim.testing.enable = lib.mkEnableOption "neovim test runner support";
  };
  ...
  config = lib.mkIf cfg.enable {
    assertions = [
      ...
      {
        assertion = config.yeldirs.cli.neovim.treesitter.enable;
