{
  ...
  cfg = config.yeldirs.cli.essentials.neovim.early-retirement;
in {
  options = {
    yeldirs.cli.essentials.neovim.early-retirement.enable = lib.mkEnableOption "neovim plugin early-retirement";
  };
